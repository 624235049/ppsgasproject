  ...
  Future<Null> initDatabase() async {
    await openDatabase(join(await getDatabasesPath(), nameDatabase),
        onCreate: (db, version) => db.execute(
            'CREATE $tableDatabase Test ($idColumn INTEGER PRIMARY KEY, $gas_id TEXT, $gas_brand_id TEXT,$gas_brand_name TEXT, $gas_zie_id TEXT, $price TEXT, $qty TEXT, $amount TEXT, $sum TEXT, $distance TEXT, $transport)'),
        version: version);
  }
}
